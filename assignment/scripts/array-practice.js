...
let foodArray = ['sushi', 'thai', 'creole', 'shrimp'];
...
console.log('Number of my favorite foods:', foodArray.length);
...
console.log('Added one more favorite food to the end,', foodArray);
...
console.log('My new list of foods are', foodArray);
